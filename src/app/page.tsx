...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        >
          {Array.from({ length: 12 }, (_, i) => (
            ...
            >
              <div className="h-8 w-6 rounded-sm bg-gradient-to-br from-purple-300 to-indigo-300 opacity-50" />
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Mouse Trail Effect */}
      <div
        className="pointer-events-none fixed -z-5 h-4 w-4 rounded-full opacity-20 transition-all duration-300"
        style={{
