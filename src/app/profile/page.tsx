...
export default function ProfilePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        >
          {Array.from({ length: 15 }, (_, i) => (
            ...
            >
              <div className="stamp-perforations h-10 w-8 rounded-sm border border-purple-400 bg-gradient-to-br from-purple-300 to-indigo-300 opacity-60" />
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Mouse Trail Effect */}
      <div
        className="pointer-events-none fixed -z-5 h-6 w-6 rounded-full opacity-25 transition-all duration-300"
        style={{
