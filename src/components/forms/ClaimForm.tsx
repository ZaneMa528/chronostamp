    ...
    <Card className="mx-auto w-full max-w-md">
      ...
      <CardContent className="space-y-4 sm:space-y-6">
        <div>
          ...
          />
          <p className="mt-1 text-center text-xs text-gray-500">Event codes are provided by organizers at events</p>
        </div>
        ...
        {!user.isConnected ? (
          <p className="text-center text-xs text-gray-500 sm:text-sm">👆 Connect your wallet above to claim stamps</p>
        ) : !eventCode.trim() ? (
          <p className="text-center text-xs text-gray-400 sm:text-sm">Enter an event code to continue</p>
        ) : (
