...
export function StampCard({ stamp, size = 'md', interactive = true, onCopy }: StampCardProps) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className={`transform-style-preserve-3d relative h-full w-full cursor-pointer transition-transform duration-700 ${interactive && isFlipped ? 'rotate-y-180' : ''} `}
              ...
              <div className="stamp-perforations h-full w-full rounded-lg bg-white p-2 shadow-2xl">
                ...
                >
                  ...
                  <div className="px-4 pb-2">
                    ...
                    >
                      <span className="font-mono">{new Date(stamp.eventDate).getFullYear()}</span>
                      <div
                      ...
                      <span className="font-mono">#{stamp.tokenId}</span>
                    </div>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        ...
                        <div>
                          ...
                          <p className="font-mono" style={{ color: colorTheme.text }}>
                            {stamp.organizer.slice(0, 8)}...{stamp.organizer.slice(-6)}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <p className="mt-1 text-xs" style={{ color: colorTheme.textSecondary }}>
                          {Math.floor((Date.now() - new Date(stamp.claimedAt).getTime()) / (1000 * 60 * 60 * 24))} days
                          ago
                        </p>
                      </div>
                    </div>
